...
def create_conv_encoder(input_dim, latent_dim, conv_shapes=[(3,3), (3,3), (3,3)], num_filters=[32, 64, 64]):
...
def create_conv_decoder(latent_dim, output_dim, hidden_units=[16, 8]):
